...
pub fn hard_totals_chart(
    ...
    if total == 13 {
        if dealer_up_card == 2 && true_count <= -1 {
    ...
    if total == 12 {
        if dealer_up_card == 4 && running_count < 0 {
            return Some(Decision::Hit);
        }

        if (dealer_up_card == 2 && true_count >= 3) || (dealer_up_card == 3 && true_count >= 2) {
            return Some(Decision::Stand);
        }
    ...
    if total == 10 {
        if ((dealer_up_card >= 2 && dealer_up_card <= 9)
            ...
            || (dealer_up_card == 11 && true_count >= 3 && rules.game_type == GameType::Hit17)
            || (dealer_up_card == 11 && true_count >= 4 && rules.game_type == GameType::Stand17))
            && cards_in_hand.len() == 2
        {
            return Some(Decision::Double);
        }
